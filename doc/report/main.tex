...
%% PART 2
\input{report/abstract.tex}		%% Optional
\input{report/preface.tex}		%% Optional
\input{report/acknowledgements.tex}		%% Optional
\input{list.tex}			%% Generate TOC, list of tables, and list of figures automatically
\input{report/abbreviations.tex}	%% Optional
...
\input{report/appendix.tex}		%% Optional
